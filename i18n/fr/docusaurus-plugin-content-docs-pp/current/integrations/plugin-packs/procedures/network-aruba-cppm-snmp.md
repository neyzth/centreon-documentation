...
> Les services listés ci-dessus sont créés automatiquement lorsque le modèle d'hôte **Net-Aruba-Cppm-SNMP** est utilisé.
...
```bash
OK:   | 'cpu.utilization.percentage'=66%;;;0;100 'core.cpu.utilization.percentage'=79%;;;0;100 
```
...
|:----------------|:----------------------------------------|
| cpu             | Net-Aruba-Cppm-Cpu-SNMP-custom          |
| disks           | Net-Aruba-Cppm-Disks-SNMP-custom        |
| interfaces      | Net-Aruba-Cppm-Interfaces-SNMP-custom   |
| list-interfaces | Used for service discovery              |
| memory          | Net-Aruba-Cppm-Memory-SNMP-custom       |
| radius          | Net-Aruba-Cppm-Radius-SNMP-custom       |
| repositories    | Net-Aruba-Cppm-Repositories-SNMP-custom |
| tacacs          | Net-Aruba-Cppm-Tacacs-SNMP-custom       |
