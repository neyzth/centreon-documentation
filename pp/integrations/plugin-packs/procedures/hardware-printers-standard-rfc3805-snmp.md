...
> The services listed above are created automatically when the **HW-Printer-standard-rfc3805** host template is used.
...
> Applies to the following service templates: Impressions, Impressions
...
> Applies to the following service templates: MarkerSupply-Usage, MarkerSupply-Usage
...
> Applies to the following service templates: PaperTray-Usage, PaperTray-Usage
